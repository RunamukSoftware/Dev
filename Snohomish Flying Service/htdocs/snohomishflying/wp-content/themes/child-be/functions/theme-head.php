...
if( ! function_exists( 'mfn_styles' ) )
{
	function mfn_styles() 
	{
		...
		wp_enqueue_style( 'mfn-base',			get_stylesheet_directory_uri() .'/css/base.css', false, THEME_VERSION, 'all' );
		wp_enqueue_style( 'mfn-layout',			get_stylesheet_directory_uri() .'/css/layout.css', false, THEME_VERSION, 'all' );
		wp_enqueue_style( 'mfn-shortcodes',		get_stylesheet_directory_uri() .'/css/shortcodes.css', false, THEME_VERSION, 'all' );	
		...
		if( mfn_opts_get('responsive') ){
			wp_enqueue_style( 'mfn-responsive', get_stylesheet_directory_uri() .'/css/responsive.css', false, THEME_VERSION, 'all' );
		} else {
			wp_enqueue_style( 'mfn-responsive-off', get_stylesheet_directory_uri() .'/css/responsive-off.css', false, THEME_VERSION, 'all' );
		}
...
if( ! function_exists( 'mfn_scripts' ) )
{
	function mfn_scripts() 
	{
		if( ! is_admin() ){
			...
			wp_enqueue_script( 'jquery-plugins', 		get_stylesheet_directory_uri(). '/js/plugins.js', false, THEME_VERSION, true );
			wp_enqueue_script( 'jquery-mfn-menu', 		get_stylesheet_directory_uri(). '/js/menu.js', false, THEME_VERSION, true );
			...
			if( $parallax == 'translate3d' ){
				wp_enqueue_script( 'jquery-mfn-parallax', get_stylesheet_directory_uri(). '/js/parallax/translate3d.js', false, THEME_VERSION, true );
			} elseif( $parallax == 'stellar' ){
				wp_enqueue_script( 'jquery-stellar', 	get_stylesheet_directory_uri(). '/js/parallax/stellar.js', false, THEME_VERSION, true );
			}
			
			if( mfn_opts_get( 'nice-scroll' ) == 'smooth' ){
				wp_enqueue_script( 'jquery-smoothscroll', get_stylesheet_directory_uri(). '/js/parallax/smoothscroll.js', false, THEME_VERSION, true );
			}
			
			// scripts config -----------------------------
			mfn_scripts_config();
			
			wp_enqueue_script( 'jquery-scripts', 		get_stylesheet_directory_uri(). '/js/scripts.js', false, THEME_VERSION, true );
