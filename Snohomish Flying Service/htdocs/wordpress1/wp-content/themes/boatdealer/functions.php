...
define('BOATDEALERPATH', get_theme_file_path() );
$theme = wp_get_theme( );
...
function boatdealer_admin_notice() {
                ...
                // $bd_msg .= '<h3>For details and help, take a look at our Help Page at your left menu Appearance => BoatDealer Theme Help';
