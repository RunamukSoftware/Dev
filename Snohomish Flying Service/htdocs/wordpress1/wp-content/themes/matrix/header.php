        ...
        <header class="clearfix header1">
            ...
            <div id="container"> <?php if (($matrix_theme_options['site_layout'] == "boxed-page") && ($matrix_theme_options['headersticky'] == 1)){ ?>
              ...
              echo YITH_WCWL()->count_products();?></span>)</a></li><?php
                                    ...
                                    <?php if ($matrix_theme_options['social_media_header']) { ?>
                                        <div class="col-md-5">
                                            ...
                                            <ul id="social-list-header" class="social-list">
                                                ...
                                                <?php } 
                                                if ($matrix_theme_options['social_skype_link'] != '') { ?>
                                                    <li>
                                                        <a class="skype itl-tooltip" data-placement="bottom"
                                                           title="Skype"
                                                           href="<?php echo esc_attr($matrix_theme_options['social_skype_link']); ?>">
                        ...
                        <div class="navbar navbar-default navbar-top" <?php if ($matrix_theme_options['headersticky'] == 1){ echo "role='navigation' data-spy='affix' data-offset-top='50' "; } ?> 
                            ...
                            <div class="container abc">
                                <div class="navbar-header" <?php if ($matrix_theme_options['logo_layout'] == "right") {
									...
									if($header_text)
									{ ?>
                                    <h1 class="site-title"><a id="alogo" href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home"><?php
