        ...
        <div class="section-video-content text-center">
            ...
            <?php if ($matrix_theme_options['anim_texts'] != "") {
                ...
                <h1 class="fittext wite-text uppercase tlt">
                    ...
                    <span id="banner_desc"><?php echo wp_kses_post($matrix_theme_options['home_callout_description']); ?></span>
                </h1>
                <?php }else{ ?>
                    ...
                    if ($matrix_theme_options['home_callout_btn_1'] != "") {
                        ...
                        <a id="banner_btn_1"
                           ...
                           class="slider btn btn-primary call_btn1 animated bounceInUp"><i id="banner_icon_1"
                                                                                           class="fa fa-<?php echo esc_attr($matrix_theme_options['home_callout_btn1_icon']); ?>"></i><span><?php echo esc_attr($matrix_theme_options['home_callout_btn_1']); ?></span></a>
                    <?php }
                    if ($matrix_theme_options['home_callout_btn_2'] != "") { ?>
                        <a id="banner_btn_2" class="animated4 slider btn btn-default btn-min-block call_btn2"
                           href="<?php echo esc_url($matrix_theme_options['home_callout_btn2_link']); ?>"><i
                                id="banner_icon_2"
                                class="fa fa-<?php echo esc_attr($matrix_theme_options['home_callout_btn2_icon']); ?>"></i><span><?php echo esc_attr($matrix_theme_options['home_callout_btn_2']); ?></span></a>
                    <?php } ?>
                </p>
            <?php } ?>
        </div>
