(function ($) {
    ...
    wp.customize('matrix_theme_options[show_topbar]', function (value) {
        value.bind(function (to) {
            if (to) {
                $('.top-bar').show();
            } else {
    ...
    wp.customize('matrix_theme_options[home_callout_btn1_icon]', function (value) {
        value.bind(function (to) {
            $('i#banner_icon_1').attr('class', 'fa fa-'+to);
        });
    });
    ...
    wp.customize('matrix_theme_options[home_callout_btn2_icon]', function (value) {
        value.bind(function (to) {
            $('i#banner_icon_2').attr('class', 'fa fa-'+to);
        });
    });
    /* Social Options */
