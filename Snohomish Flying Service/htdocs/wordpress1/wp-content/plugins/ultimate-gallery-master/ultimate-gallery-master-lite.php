...
add_action('admin_menu', 'ugml_general_setting_page'); 
function ugml_general_setting_page() {
    add_submenu_page(
        'edit.php?post_type=ugml_cpt',
        __( 'General Settings', 'UGML_TEXT_DOMAIN' ),
        __( 'General Settings', 'UGML_TEXT_DOMAIN' ),
        'manage_options',
        'ugml_general_option_page',
        'ugml_general_settings_ref_page_callback'
    );
}
...
class UGML {
	...
	function ugml_gallery_column( $columns ){
		$columns = array(
			...
			'title' => __( 'All Galleries','UGML_TEXT_DOMAIN' ),
			'shortcode' => __( 'Gallery Shortcodes','UGML_TEXT_DOMAIN' ),
			'date' => __( 'Date','UGML_TEXT_DOMAIN' )
		);
		return $columns;
	}
	...
	public function ugml_activate_sublink($links){
		$plugin_submenu_added_link=array();		
		 $added_link = array(
		 '<a target="_blank" style="color: rgba(10, 154, 62, 1); font-weight: bold; font-size: 13px;" href="https://www.webhuntinfotech.com/amember/signup/ugmp">Upgrade to Pro</a>',
		 );
	...
	function Rate_us_meta_box_ugml() { ?>
		<div align="center">
			<p><?php _e('Please Review & Rate Us On WordPress','UGML_TEXT_DOMAIN'); ?></p>
			<div class="stars">
		...
		<div style="text-align:center;margin-bottom:15px;margin-top:25px;">
			<a href="https://wordpress.org/support/plugin/ultimate-gallery-master/reviews/?filter=5" target="_blank" title="rate us" class="btn-web button-4"><?php _e('RATE US','UGML_TEXT_DOMAIN'); ?></a>
		</div>
	<?php
	}
	...
	?>
		<ul style="">
			...
			<li class="plan-feature">(4) <?php _e('Full multimedia support (image, youtube, vimeo, self hosted video, youku video, audio, flash file, iframe, google maps, external link).','UGML_TEXT_DOMAIN'); ?></li>
			...
			<li class="plan-feature">(32) <?php _e('Translation ready.','UGML_TEXT_DOMAIN'); ?></li>
			<li class="plan-feature">(33) <?php _e('Updates and support.','UGML_TEXT_DOMAIN'); ?></li>
			<li class="plan-feature">(34) <?php _e('Extensive documentation.','UGML_TEXT_DOMAIN'); ?></li>
			<li class="plan-feature">(35) <?php _e('And many more..','UGML_TEXT_DOMAIN'); ?></li>
		</ul>
	<?php
	}
						...
						<li class="ugml-image-entry" id="ugml_img">
								...
								<p>
									...
									<select name="UGML_display_type[]" id="UGML_display_type[]" style="width:100%; margin-top:5px;">
										<optgroup label="Select Type">
											...
											<option value="link" <?php if($type == 'link') echo "selected=selected"; ?>> <?php _e('Link','UGML_TEXT_DOMAIN')?></option>
							...
							<div class="ugml-admin-inner-div2" >
								...
								<p>
									...
									<input type="text" id="UGML_image_label[]" name="UGML_image_label[]" value="<?php echo esc_attr($name); ?>" placeholder="Enter Image Label Name" class="ugml_label_text">
								</p>
								<p>
								...
								<p>
									...
									<input type="text" id="UGML_external_link[]" name="UGML_external_link[]" value="<?php echo esc_url($link); ?>" placeholder="Enter Video/Link URL" class="ugml_label_text">
								</p>
								<p>
		...
		<li class="ugml-image-entry" id="ugml_img">
				...
				<p>
					...
					<select name="UGML_display_type[]" id="UGML_display_type[]" style="width:100%;">
						<optgroup label="Select Type">
							...
							<option value="link"> <?php _e('Link','UGML_TEXT_DOMAIN')?></option>
						</optgroup>
					</select>
				</p>
			</div>
			<div class="ugml-admin-inner-div2" >
				...
				<p>
					...
					<input type="text" id="UGML_image_label[]" name="UGML_image_label[]" placeholder="Enter Image Label Name" class="ugml_label_text">
				</p>
				<p>
					<label class="ugml_label labelspace" style="vertical-align:top;"><?php _e('Description','UGML_TEXT_DOMAIN')?> </label>
				...
				<p>
					<label class="ugml_label"><?php _e('Video/Link URL','UGML_TEXT_DOMAIN')?> </label>
					<input type="text" id="UGML_external_link[]" name="UGML_external_link[]" placeholder="Enter Video/Link URL" class="ugml_label_text">
				</p>
				<p>
					<label class="ugml_label"><?php _e('Extra Button URL','UGML_TEXT_DOMAIN')?> </label>
