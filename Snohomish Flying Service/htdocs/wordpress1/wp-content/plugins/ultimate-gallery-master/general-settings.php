 ...
 */	
	jQuery('#UGMP_showShareButton').click(function () {
 ...
 */
	jQuery('#sub-lvl-filter input[type="checkbox"]').change(function(){
		...
		if(a.length > a.filter(":checked").length && a.filter(":checked").length > 0){
			jQuery('#UGMP_showShareButton').prop('checked','checked');
		}
		else if(a.filter(":checked").length < 1){
			jQuery('#UGMP_showShareButton').prop('checked','');
		}
	});
...
<form action="" method="post" id="adminForm"
    ...
    <ul id="lightbox_type" >
		<li class="<?php if ( $ugmp_general_settings['UGMP_generalOptionType'] == 'lightbox' ) {
			echo "active";
		} ?>">
			<label for="lightbox"><?php _e('Lightbox Settings','UGML_TEXT_DOMAIN'); ?></label>
			<input type="checkbox" name="params[UGMP_generalOptionType]"
				   id="lightbox" <?php if ( $ugmp_general_settings['UGMP_generalOptionType'] == 'lightbox' ) {
				echo 'checked';
			} ?>
				   value="lightbox">
		</li>
		<li class="<?php if ( $ugmp_general_settings['UGMP_generalOptionType'] == 'other' ) {
			echo "active";
		} ?>">
			<label for="other"><?php _e('Other Settings','UGML_TEXT_DOMAIN'); ?></label>
			<input type="checkbox" name="params[UGMP_generalOptionType]"
				   id="other" <?php if ( $ugmp_general_settings['UGMP_generalOptionType'] == 'other' ) {
				echo 'checked';
			} ?>
				   value="other">
		</li>
    ...
    <div id="new-lightbox-options-list"
         class="unique-type-options-wrapper <?php if ( $ugmp_general_settings['UGMP_generalOptionType'] == 'lightbox' ) {
             echo "active";
         } ?>">
        <div class=""></div>
