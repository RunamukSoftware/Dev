...
[Live Preview](https://abcfolio.com/wordpress-free-plugin-staff-list-live-preview/)
...
Staff List is well suited to create both small and large staff directories.

[Live Previews](https://abcfolio.com/wordpress-plugin-staff-list-live-previews/)
...
[https://abcfolio.com/wordpress-plugin-staff-list-documentation-quick-start/](https://abcfolio.com/wordpress-plugin-staff-list-documentation-quick-start/).
...
* Three distinct layouts: [List](https://abcfolio.com/wordpress-plugin-staff-list-live-preview-list-layout/), [Grid A](https://abcfolio.com/wordpress-plugin-staff-list-live-preview-grid-layout/) and [Grid B.](https://abcfolio.com/staff-list-live-preview-grid-image-left-text-right/)
* Single page option: [Live Preview.](https://abcfolio.com/wordpress-plugin-staff-list-live-preview-list-single/?smid=2740)
* Social Icons. [Live Preview.](https://abcfolio.com/wordpress-plugin-staff-list-live-preview-list-layout/)
...
* <strong>CSV Import-Export.</strong> Simple way to import data from any spreadsheet. [Plugin extension.](https://abcfolio.com/staff-list-csv/)
* <strong>Staff List Search.</strong> Advanced search options. [Plugin extension.](https://abcfolio.com/wordpress-plugin-staff-list-search-live-previews/)

[Full List of Features.](https://abcfolio.com/wordpress-plugin-staff-list-get-plugin/)
[Staff List Pro](https://abcfolio.com/wordpress-plugin-staff-list-pro-version/)
...
[Installation instructions can be found here.](https://abcfolio.com/wordpress-plugin-staff-list-documentation-installation/).
...
= 0.5.1 20171215 =
* Update: Added templates filter to Staff Members adminscreen.
...
* Update: Added support for custom permlinks page title.
