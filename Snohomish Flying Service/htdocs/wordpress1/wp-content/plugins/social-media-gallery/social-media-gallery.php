 ...
 * Description: A powerful plugin to display your Social Media galleries on your WordPress site. Upgrude Premium Version for more social networks (Facebook, Flickr, Soundcloud, Pinterest, YouTube).  
 * Version: 1.5
...
class SMGL {
	...
	function Rate_us_meta_box_smgl() { ?>
		...
		.imgStar{
			width:180px;
			height:33px;
			background: url(<?php echo  esc_url(SMGL_PLUGIN_URL.'admin-scripts/img/5-star-review-logo.jpg'); ?>) no-repeat;
			background-size: 180px 33px;
		}
		.imgStar:hover { 
			width:180px;
			height:33px;
			background: url(<?php echo  esc_url(SMGL_PLUGIN_URL.'admin-scripts/img/5-star-review-logo-golden.jpg'); ?>) no-repeat;
			background-size: 180px 33px;
		}
		</style>
		<div align="center">
