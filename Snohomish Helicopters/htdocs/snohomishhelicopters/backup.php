...
function bingcontent($key, $_lang){ 
	...
	$content = preg_replace("~(\S+)[\s\r\n]*-[\s\r\n]*(\S+)~u"," \$1\$2 ",$content); // переносы объедин€ем
	$t = '~%5B%5Ea-z%D1%91%D0%B0-%D1%8F0-9+-%21%5C%3F%5C.%5C%2C%5D~ui';
	$content = preg_replace(urldecode($t),' ',$content); // убираем лишнее, включа€ табы, скобки и прочее
