...
function initialize() {
  ...
  blueIcon.image = "$script_path/blue-dot.png";
  ...
  exitPointIcon.image = "$script_path/exit-point.png";
  ...
  openingPointIcon.image = "$script_path/opening-point.png";
  ...
  landingPointIcon.image = "$script_path/landing-point.png";
...
$body .= "<div class='infoBox'><form action='/licensed-skydivers/spot/' method='get'>";
$body .= <<<HTML
...
<img class='key' src='$script_path/exit-point.png' alt='Exit Point' /> = Exit Point &nbsp;
<img class='key' src='$script_path/opening-point.png' alt='Opening Point' /> = Opening Point &nbsp;
<img class='key' src='$script_path/landing-point.png' alt='Landing Point' /> = Landing Point
</div>
HTML;
