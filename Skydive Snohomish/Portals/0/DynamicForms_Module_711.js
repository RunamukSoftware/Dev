...
function calcRecurrency(){
    ...
    // Set licenseCurrency based on USPA license held
    var licenseHeld = document.getElementById($(USPALicHeld_FieldID)).options;
    var licenseCurrency = 0;
    switch (true) {
        case (licenseHeld === "A"): // A license
            licenseCurrency = 30;
            break;
        case (licenseHeld === "B"): // A license
            licenseCurrency = 60;
            break;
        case (licenseHeld === "C"): // A license
            licenseCurrency = 180;
            break;
        case (licenseHeld === "D"): // A license
            licenseCurrency = 180;
            break;
    }
    ...
    switch (true) {
        case (daysOut &lt;= licenseCurrency + 7): // 1-7 days out of currency
            validDays = 7;
            break;
        case (daysOut &lt;= licenseCurrency + 60): // 7-60 days
            validDays = 60;
            break;
        case (daysOut &lt;= licenseCurrency + 90): // 60-90 days
            validDays = 90;
            break;
        case (daysOut &lt;= licenseCurrency + 365): // 90-365 days
            validDays = 365;
            break;
        case (daysOut &lt;= licenseCurrency + (365 * 2)): // 1 year - 2 years
            validDays = (365 * 2); //730 days
            break;
        case (daysOut &lt;= licenseCurrency + (365 * 10)): // 2+ years
            validDays = (365 * 10); //3650 days
            break;
        case (daysOut &lt;= licenseCurrency + (365 * 20)): // 10+ years
            validDays = (365 * 20); //7300 days
            break;
        case (daysOut &lt;= licenseCurrency + (365 * 30)): // 20+ years
            validDays = (365 * 30); //10950 days
            break;
        case (daysOut &lt;= licenseCurrency + (365 * 100)): // 30+ years
