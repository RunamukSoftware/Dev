    ...
    <div id="divFeedbackFormContent" runat="server">
        ...
        <div id="divFooter" runat="server" class="Feedback_FooterBlock">
	        ...
	        <div id="divCaptcha" runat="server">
                <div class="dnnFormItem">
                    <asp:label id="plCaptcha" runat="server" associatedcontrolid="ctlCaptcha" resourcekey="plCaptcha"></asp:label>
                    <div class="divCaptcha">
                    <dnn:dnnCaptcha ID="ctlCaptcha" runat="server" EnableRefreshImage="True" CaptchaImage-AudioFilesPath="~/DesktopModules/Feedback/App_Data/RadCaptcha" />
                    </div>
                </div>
	        </div>
        </div>
